...
public class WindowHelper {
    ...
    public static void setResizable(Stage stage) {
    ...
    public static void setDraggable(Parent parent) {
        parent.setOnMousePressed(event -> {
            xOffset = parent.getScene().getWindow().getX() - event.getScreenX();
            yOffset = parent.getScene().getWindow().getY() - event.getScreenY();
        });
